#![doc = "Peripheral access API for ESP32-C3 microcontrollers (generated using svd2rust v0.28.0 (47f5be5 2023-05-21))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next] svd2rust release can be generated by cloning the svd2rust [repository], checking out the above commit, and running `cargo doc --open`.\n\n[here]: https://docs.rs/svd2rust/0.28.0/svd2rust/#peripheral-api\n[next]: https://github.com/rust-embedded/svd2rust/blob/master/CHANGELOG.md#unreleased\n[repository]: https://github.com/rust-embedded/svd2rust"]
...
impl layout_trait::SafeLayout for AES {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
...
impl layout_trait::SafeLayout for APB_CTRL {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for APB_SARADC {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for ASSIST_DEBUG {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for BB {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for DMA {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for DS {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for EFUSE {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for EXTMEM {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for GPIO {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for GPIO_SD {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for HMAC {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for I2C0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for I2S0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for INTERRUPT_CORE0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for IO_MUX {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for LEDC {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for RMT {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for RNG {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for RSA {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for RTC_CNTL {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for SENSITIVE {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for SHA {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for SPI0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for SPI1 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for SPI2 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for SYSTEM {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for SYSTIMER {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for TIMG0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for TIMG1 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for TWAI0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for UART0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for UART1 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for UHCI0 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for UHCI1 {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for USB_DEVICE {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
...
impl layout_trait::SafeLayout for XTS_AES {
    fn get_layout(&self) -> layout::Layout {
        layout::Layout {
            address: self.deref() as *const _ as usize,
            size: core::mem::size_of_val(self.deref()),
